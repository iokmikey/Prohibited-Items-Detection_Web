...
#define DOCUMENT_ROOT "/home/wxxz/workspace/DetectionOfContraband/UI_SRC"
#define PORT "8089"
...
// 统一成秒
#ifdef _WIN32
#define civetSleep(second) Sleep(second * 1000)
#else
#define civetSleep(second) sleep(second) 
#endif
...
int main(int argc, char *argv[])
{
	...
	printf("Run example at http://localhost:%s\n", PORT);
